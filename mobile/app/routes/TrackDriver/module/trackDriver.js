...
export function getDriverInfo() {
  return (dispatch, store) => {
    const id = store().home.booking.driverId;
    request.get('http://localhost:3000/api/driver/' + id).finish((erroe, res) => {
      dispatch({
...
export function getDriverLocation() {
  return (dispatch, store) => {
    const id = store().home.booking.driverId;
    request.get('http://localhost:3000/api/driverLocation/' + id).finish((erroe, res) => {
      dispatch({
